...
export default function ProductCard({ product }: { product: Product }) {
    ...
    useEffect(() => {
        setIsInCart(cart?.find((item) => item.product.id === product.id) ? true : false)
    }, [cart, product.id]);
        ...
        <div
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <span className="badge badge-primary">{product.status == 0 ? "New" : "Old" }</span>
                    </div>
                </Link>
                <div className="flex items-center justify-between">
                    <span className="text-xl font-bold text-gray-900 dark:text-white">{Intl.NumberFormat().format(product.price)} <span className=" text-base text-gray-400">ETB</span></span>
                    <button
