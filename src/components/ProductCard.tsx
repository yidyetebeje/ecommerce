...
export default function ProductCard({ product }: { product: Product }) {
    ...
    return (
        <div
            className=" lg:w-1/4 sm:w-full md:w-1/2 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-5 pb-5">
                <Link to={`/products/${product.id}`}>
                <a href="#">
                    <h5 className="text-base font-semibold tracking-tight text-gray-900 dark:text-white text-start">{product.title}</h5>
                </a>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-xl font-bold text-gray-900 dark:text-white">${Intl.NumberFormat().format(product.price)}</span>
                    <button
