...
import { useSignInWithGoogleMutation } from "../services/auth/auth"

export default function SignInWithGoogle() {
    const [signIn, status] = useSignInWithGoogleMutation();
    const onClick = () => {
        signIn();
    }
