    ...
    return (
        <div>
            ...
            <input type={type} name={label} id={label} value={value}
                ...
                ${error ? 'dark:focus:ring-red-500 dark:focus:border-red-500  focus:ring-red-600  focus:border-red-600 border-red-600' : 'dark:focus:ring-primary-500 dark:focus:border-primary-500  focus:ring-primary-600  focus:border-primary-600'}`} placeholder={placeholder} onChange={(e) => onChange(e.currentTarget.value)} value={value} />
        </div>
    )
}